...
if(${_COMPONENT_NAME}_LIB_FOUND AND EXISTS "${_${_COMPONENT_NAME}_INCLUDE_DIR}/${_COMPONENT_HEADER}")
    ...
    foreach(ITEM ${_EXTRA_LIBS})
        target_link_libraries(${PROJECT_NAME} PUBLIC "-Wl,--whole-archive" ${_${_COMPONENT_NAME}_LIB_DIR}/${ITEM} "-Wl,--no-whole-archive")
    endforeach()
    foreach(ITEM ${_EXTRA_INCLUDES})
        target_include_directories(${PROJECT_NAME} PUBLIC ${_${_COMPONENT_NAME}_INCLUDE_DIR}/${ITEM})
    endforeach()
elseif(_USER_DEFINED_PATHS)
    ...
    if (DEFINED _EXTRA_INCLUDES)
        get_target_property(${_COMPONENT_NAME}_INCLUDE_DIR ${_COMPONENT_LIB_NAME} INCLUDE_DIRECTORIES)
        target_include_directories(${PROJECT_NAME} PUBLIC ${${_COMPONENT_NAME}_INCLUDE_DIR})
    endif()
endif()
target_link_libraries(${PROJECT_NAME} PUBLIC "-Wl,--whole-archive" ${_COMPONENT_LIB_NAME} "-Wl,--no-whole-archive")
