...
MatMultEIPBenchmarkDescription::MatMultEIPBenchmarkDescription()
{
    ...
    default_workload_params.add<std::uint64_t>(MatMultEIPBenchmarkDescription::DefaultScaleExponent, "ScaleBits");
    ...
    m_w_params(bench_params)
{
    ...
    std::size_t scale_bits = m_w_params.get<std::uint64_t>(MatMultEIPBenchmarkDescription::Index_ScaleExponent);
...
std::vector<std::vector<double>> MatMultEIPBenchmark::prepareMatrix(const hebench::APIBridge::NativeDataBuffer &buffer,
...
std::vector<lbcrypto::Plaintext> MatMultEIPBenchmark::encodeMatrix(const std::vector<std::vector<double>> &data)
{
...
std::vector<lbcrypto::Plaintext> MatMultEIPBenchmark::encodeM0(const std::vector<std::vector<double>> &data)
{
...
std::vector<lbcrypto::Plaintext> MatMultEIPBenchmark::encodeM1(const std::vector<std::vector<double>> &data)
{
...
hebench::APIBridge::Handle MatMultEIPBenchmark::encode(const hebench::APIBridge::DataPackCollection *p_parameters)
{
...
void MatMultEIPBenchmark::decode(hebench::APIBridge::Handle h_encoded_data, hebench::APIBridge::DataPackCollection *p_native)
{
...
{
    if (indexers_count < MatMultEIPBenchmarkDescription::NumOpParams)
    {
        std::stringstream ss;
        ss << "Invalid number of indexers. Expected " << MatMultEIPBenchmarkDescription::NumOpParams
    ...
    // validate indexers
    for (std::size_t param_i = 0; param_i < MatMultEIPBenchmarkDescription::NumOpParams; ++param_i)
    {
