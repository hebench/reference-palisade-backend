...
std::vector<lbcrypto::Plaintext> MatMultValBenchmark::encodeMatrix(const std::vector<std::vector<std::int64_t>> &data)
{
...
std::vector<lbcrypto::Plaintext> MatMultValBenchmark::encodeM0(const std::vector<std::vector<std::int64_t>> &data)
{
...
std::vector<lbcrypto::Plaintext> MatMultValBenchmark::encodeM1(const std::vector<std::vector<std::int64_t>> &data)
{
